package com.thedoggy.chariot_requiem_addon.client.particle;
...
public class ChariotVirusParticle extends SpriteTexturedParticle {
    private final float yRot;
    private final float xRot;

    protected ChariotVirusParticle(ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType type, ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ChariotVirusParticle particle = new ChariotVirusParticle(world, x, y, z, xSpeed, ySpeed, zSpeed);
